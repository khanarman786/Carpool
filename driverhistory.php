...
<body class="body"">
  <nav class=" navbar navbar-expand-lg navbar-light bg-light" static-top">
    ...
    <div class="rideinfo" style="position: relative;">
        <?php
        $checkingrides = "SELECT * FROM `$myphone` ORDER BY `id` DESC";
        $result = mysqli_query($dri, $checkingrides);
        ...
        ?>
                <div class="card">
                    <div class="card-header" style="text-align: center;">
                        <span><?php echo $day; ?></span><span><?php echo " "; ?></span><span><?php echo $enddate; ?></span>
                    </div>
                    <div class="card-body" style="text-align:center;">
                        <p class="card-text" id="jagah">From : <?php echo $source; ?></p>
                        <p class="card-text" id="jagah">To : <?php echo $destination; ?></p>
                        <p class="card-text" id="jagah">Earning : <?php echo $earning; ?> Rs</p>
                    
                        <button type="button" class="btn btn-primary" data-toggle="modal" id="starting" data-target="#exampleModal-<?php echo $row['id']; ?>">
                           More details
                        </button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel-<?php echo $row['id']; ?>">Details</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Driver name : <?php echo $source; ?></p>
                                        <p>Contact : <?php echo $destination; ?></p>
                                        <p>Seat bookings : <?php echo $seatbooked; ?></p>
