...
unset($_SESSION['srides']);
echo $_SESSION['srides'];
            ?>
  <!DOCTYPE html>
    ...
    <div class="maincontainer" id="main">
      ...
      <form action="creatingride.php" method="POST">
        <div class="selectroute">
          ...
          <!-- <input type="datetime-local" class="inputforroute" placeholder="enter ride timimng"id="ridetime" name="ridetiming"> -->
  ...
  <a href="sdriver.php">
  <button type="submit" class="btn btn-primary">Want to publish ride for later </button></a>
